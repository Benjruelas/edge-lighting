      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_1.05fr] lg:items-start">
        <Reveal>
          <SectionHeading
            ...
            description="Tell us about your home. We’ll call to schedule a free on-site measure — footage, package recommendation, and a clear quote so you can lock in $24.25/ft if you order before Thanksgiving. Don’t love it? You pay nothing."
          />
